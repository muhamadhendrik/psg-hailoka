  ...
  >
    ...
    <div class="py-4 space-y-3">
      <p class="text-gray-800 text-base">
        Are you sure you want to reopen this organization? All extensions will become active again.
      </p>
    </div>
    ...
    <template #footer>
      <div class="flex justify-end gap-3 pt-4">
        ...
        />
        <Button
          label="Reopen Organization"
          class="rounded-full px-5 border-0"
          style="background-color: #02b1d6; color: white;"
          @click="onConfirm"
        />
      </div>
    </template>
