...
<template>
  ...
  >
    ...
    <template #header>
      ...
      <div class="w-full bg-[#6B7280] text-white flex flex-col p-4 rounded-t-lg">

        <div class="flex justify-between items-center border-b py-4">
          <span class="text-lg font-medium">Resume Call</span>
        ...
        <div class="flex items-center mt-4">
          <div class="rounded-full bg-transparent border-2 bg-opacity-20 p-3 mr-4">
            <Icon icon="si:phone-paused-line" width="24" height="24" />
          </div>

          <div>
            <div class="font-semibold text-lg">Alan Maker</div>
            <div class="text-sm opacity-90">On Hold - 00:05:34</div>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white p-6 flex flex-col items-center space-y-6">
      ...
      <div class="flex flex-col gap-4 justify-center space-x-6 mt-2">
        ...
        <p class="text-gray-900">
            Resuming will immediately reconnect the guest with the assigned staff.
        </p>

        <p class="text-sm">
            Note: Make sure the staff is available to continue the call before resuming.
        </p>
      ...
      <div class="flex items-center justify-between w-full space-y-2">
            ...
            <div class="flex gap-3">
                ...
                <Button variant="text" class="rounded-full! bg-cyan-600! text-white! font-semibold">Resume Call</Button>
            </div>
        </div>
