...
//         severity: "info",
//         summary: "Success",
//         detail: 'A new staff has been successdully created',
//         group: "custom",
//         life: 100000,
//     });

  const res = await extensionRuleServices.createNewExtensionRule(form.value)
  ...
  if (res.status == 201) {
    ...
    toast.add({
        severity: "info",
        summary: "Success",
        detail: 'A new extension rule has been successdully created',
        group: "custom",
        life: 100000,
    });
    
    setTimeout(() =>  router.push({ name: "ListRulesExtension", params: { organizationId } }), 3000);
  }
